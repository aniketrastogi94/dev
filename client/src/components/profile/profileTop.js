    ...
    return (
        <div className="profile-top bg-primary p-2">
          ...
          <p>{location && <span>{location}</span>}</p>
            ...
            {website &&(<a href={website} target="_blank" rel="noopener noreferrer"><i className="fas fa-globe fa-2x"/></a>)}
            {social && social.twitter && (<a href={social.twitter} target="_blank" rel="noopener noreferrer"><i className="fab fa-twitter fa-2x"/></a>)}
